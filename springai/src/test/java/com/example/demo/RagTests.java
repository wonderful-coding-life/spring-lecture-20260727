...
public class RagTests {
    ...
    public void testVectorStoreWrite() {
        vectorStore.write(texts.stream().map(Document::new).toList());
    }

    @Test
    public void testSimpleSimilaritySearch() {
        String question = "신입사원의 수습 기간은 얼마나 되나요?";
